...
val dbDependencies = Seq(
  ...
  "org.flywaydb" % "flyway-database-postgresql" % "11.14.0" // database migrations
)
...
val jsonDependencies = Seq(
  ...
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.38.3" // automatic codec derivation
)

val loggingDependencies = Seq(
  "ch.qos.logback" % "logback-classic" % "1.5.19", // main logging library
...
val mainClassName = "com.algocode.sheetmusic.Main"
...
lazy val commonSettings = Seq(
  organization := "com.algocode.sheetmusic",
  scalaVersion := "3.7.3",
  // version
...
lazy val backend: Project = (project in file("backend"))
  ...
  .settings(
    ...
    generateOpenAPIDescription := Def.taskDyn {
      ...
      Def.task {
        (Compile / runMain).toTask(s" com.algocode.sheetmusic.writeOpenAPIDescription $targetPath").value
      }
    }.value,
  ...
  .settings(
    ...
    buildInfoPackage := "com.algocode.sheetmusic.version",

package com.algocode.sheetmusic.test

import com.algocode.sheetmusic.Fail
import com.algocode.sheetmusic.passwordreset.PasswordResetApi
import com.algocode.sheetmusic.passwordreset.PasswordResetApi.*
import com.algocode.sheetmusic.user.UserApi
import com.algocode.sheetmusic.user.UserApi.*
import com.algocode.sheetmusic.util.Strings.asId
import sttp.client4.*
...
class Requests(backend: SyncBackend):
  ...
  def randomLoginEmailPassword(): (String, String, String) =
    (random.nextString(12), s"user${random.nextInt(9000)}@sheetmusic.com", random.nextString(12))

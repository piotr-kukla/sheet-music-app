...
class UserValidatorSpec extends AnyFlatSpec with Matchers:
  ...
  it should "not accept password with empty spaces only" in:
    val dataIsValid = validate("login", "admin@sheetmusic.com", "    ")

package com.algocode.sheetmusic.security

import com.augustnagro.magnum.DbTx
import com.algocode.sheetmusic.logging.Logging
import com.algocode.sheetmusic.user.User
import com.algocode.sheetmusic.util.Strings.Id
import com.algocode.sheetmusic.util.{Clock, IdGenerator}

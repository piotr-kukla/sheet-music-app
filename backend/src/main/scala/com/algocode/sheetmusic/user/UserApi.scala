...
import com.algocode.sheetmusic.http.{EndpointsForDocs, ServerEndpoints}
import com.algocode.sheetmusic.infrastructure.DB
import com.algocode.sheetmusic.metrics.Metrics
import com.algocode.sheetmusic.security.{ApiKey, Auth}
import com.algocode.sheetmusic.util.Strings.{Id, asId}
...
object UserApi extends EndpointsForDocs:
  ...
  val registerUserEndpoint = baseEndpoint.post
    ...
    .in(jsonBody[Register_IN].example(Register_IN("john", "john@sheetmusic.com", "1234_abcd_ABCD")))

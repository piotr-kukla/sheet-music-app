...
export const Welcome: FC = () => (
  <div className="w-full h-full flex flex-col justify-center items-center">
    <div className="w-full h-[50%] flex flex-col items-center justify-center bg-foreground text-background text-center p-4 lg:p-0">
      ...
      <h1 className="text-3xl mb-3">Welcome to Sheetmusic!</h1>
      <p className="text-center">
        If you are interested in how Sheetmusic works,
        <br />
        you can browse the{' '}
        <a
          href="http://softwaremill.github.io/sheetmusic/"
          target="blank"
        ...
        or the{' '}
        <a
          href="https://github.com/softwaremill/sheetmusic"
          target="blank"
          rel="noopener noreferrer"
          className="underline"
        >
